...
dates = [date(2021, 10. Iterators & generators, 5), date(1992, 6. Collections, 10. Iterators & generators), date(2012, 2, 23), date(1995, 10. Iterators & generators, 12)]

print(get_min_max(dates))
Sample Output 1:

(datetime.date(1992, 6. Collections, 10. Iterators & generators), datetime.date(2021, 10. Iterators & generators, 5))
Sample Input 2:
