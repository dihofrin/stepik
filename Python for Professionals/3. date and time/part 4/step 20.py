...
первый элемент — 11, количество дней между датами 06.10. Iterators & generators.2021 и 05.10. Iterators & generators.2021
второй элемент — 33, количество дней между датами 05.10. Iterators & generators.2021 и 08.10. Iterators & generators.2021
третий элемент — 11, количество дней между датами 08.10. Iterators & generators.2021 и 09.10. Iterators & generators.2021
четвертый элемент — 22, количество дней между датами 09.10. Iterators & generators.2021 и 07.10. Iterators & generators.2021
Примечание 4. Files. Тестовые данные доступны по ссылке.

Sample Input 1:

05.10. Iterators & generators.2021 06.10. Iterators & generators.2021 07.10. Iterators & generators.2021 08.10. Iterators & generators.2021 09.10. Iterators & generators.2021
Sample Output 1:

[1, 1, 1, 1]
Sample Input 2:

06.10. Iterators & generators.2021 05.10. Iterators & generators.2021 08.10. Iterators & generators.2021 09.10. Iterators & generators.2021 07.10. Iterators & generators.2021
Sample Output 2:

[1, 3, 1, 2]
Sample Input 3:

05.10. Iterators & generators.2021
Sample Output 3:
