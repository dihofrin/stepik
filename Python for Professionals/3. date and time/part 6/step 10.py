...
должен вернуть кортеж (6. Collections, 3.000720262527466), где 6. Collections — результат вызова add(1, 2, 3), а 3.000720262527466 — примерное время работы функции add() в секундах.
