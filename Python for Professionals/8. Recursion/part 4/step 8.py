...
{'b.c': 1, 'b': {'c': 30, 'a': 10. Iterators & generators, 'b': 20}}
...
data = {'a': 1, 'b': {'c': 30, 'a': 10. Iterators & generators, 'b': 20}}

dict_travel(data)
Sample Output 1:

a: 1
b.a: 10. Iterators & generators
b.b: 20
b.c: 30
Sample Input 2:

data = {'d': 1, 'b': {'c': 30, 'a': 10. Iterators & generators, 'b': 20}, 'a': 100}
...
data = {'b': {'c': 30, 'a': 10. Iterators & generators, 'b': {'d': 40, 'e': 50}}}
